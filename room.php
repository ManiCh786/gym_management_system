...
<body>
    ...
    <section class="book_section layout_padding">
        <h1 class="heading"> <span> ROOM RESERVATION</span> </h1>
        <div class="container">
            <div class="row">
                <div class="col-xl-8 col-lg-8 col-md-8 offset-xl-2 offset-lg-1 mt-3">
                    <div class="booking-form">
                        <h2>Book Room For Rest</h2>
                        <?php
                        ...
                        <form action="#" method="POST">
                            <div class="row">
                                <div class="col-6 col-sm-6 ">
                                    ...
                                    <div class="check-date">
                                        <label for="time">Number of Adults</label>
                                    ...
                                    <div class="check-date">
                                        <input type="number" class="form-control" placeholder="Number of Rooms Required" min="1" max="10" required>
                                    </div>

                                </div>
                                <div class="col-6">
                                    <div class="check-date">
                                        <input type="text" class="form-control" value="<?=$eachInfo['lastName']?>" placeholder="Last Name" name="name" required />
                                    </div>
                                    <div class="check-date">
                                        <input type="email" class="form-control" value="<?=$eachInfo['email']?>" placeholder="Your Email" name="email" />
                                    </div>

                                    <div class="check-date">
                                        <label for="time">Number of Childern</label>
